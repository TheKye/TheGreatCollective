...
{
	[Serialized]
	[LocDisplayName("Coloured Paper Red")]
	[Weight(125)]
	[Fuel(100f)]
	[Tag("Fuel", 1)]
	[Currency]
	...
	[Tag("ColouredPaper", 1)]
	[Tag("Burnable Fuel", 1)]
	public class ColouredPaperRedItem : Item
	{
        public override LocString DisplayDescription => Localizer.DoStr("It's red paper.");
    }

	[RequiresSkill(typeof(PaperMillingSkill), 2)]
	public class ColouredPaperRedRecipe : Recipe
	{
		public ColouredPaperRedRecipe()
		{
			base.Name = "ColouredPaperRed";
			base.DisplayName = Localizer.DoStr("Coloured Paper Red");
			...
			{
				new CraftingElement<ColouredPaperRedItem>(3f)
			};
